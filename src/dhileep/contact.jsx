...
const ContactUs = () => {
  ...
  useEffect(() => {
    // Check if the window size matches mobile size
  ...
  // Inline styles with conditional styles based on isMobile
  const styles = {
    container: {
      display: 'flex',
          ...
          <Row>
            <Col className=" align-items-center flex-wrap">
              <div className="contact-info fs-3 ms-2  d-flex justify-content-center ">
                <h1 className="sayato">SAYATO-CONTACT US</h1>
              </div>
        ...
        <Row style={styles.container}  >
          <Col  className='align-items-center'>
            <div style={styles.contentContainer}>
              <h1 style={styles.header} className='text-center'> Thanks For Visit Us</h1>
              <p className='text-center'>We'd love to hear from you! Please feel free to reach out to us using the form below.</p>
          ...
          <Col >
            <div style={styles.imageContainer} >
              <img
                src="src/assets/saya/res.png"
                alt="Restaurant" 
                style={styles.image}  className='img-fluid mt-4' width={360}
              />
            </div>
          </Col>
        </Row>
