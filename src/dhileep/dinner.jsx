...
const Menu1 = [
  { id: 1, name: "Aloo Paratha ", price: 100, img: '/src/assets/saya/aloo.jpg' },
  { id: 2, name: "Appam", price: 50, img: '/src/assets/saya/appam.jpg' },
  { id: 4, name: "Curd Rice", price: 80, img: '/src/assets/saya/curd.jpg' },
  { id: 5, name: "Fried-Rice", price: 80, img: '/src/assets/saya/friedrice.jpg' },
  { id: 6, name: "Rasam With Rice", price: 15, img: '/src/assets/saya/rasam.jpg' },
];
          ...
          <Row>
            <Col className=" align-items-center flex-wrap">
              <div className="contact-info fs-3 ms-2  d-flex justify-content-center ">
                <h1 className="sayato">SAYATO-DINNER</h1>
              </div>
