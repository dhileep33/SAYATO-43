...
const Menu1 = [
  { id: 1, name: "Idly", price: 25, img: '/src/assets/saya/m1.jpeg' },
  { id: 2, name: "Upma", price: 50, img: '/src/assets/saya/upma.jpg' },
  { id: 4, name: "Dosa", price: 80, img: '/src/assets/saya/dosa.jpeg' },
  { id: 5, name: "Pongal", price: 80, img: '/src/assets/saya/pongal.jpeg' },
  { id: 6, name: "Vada", price: 15, img: '/src/assets/saya/vada.jpg' },
];
  ...
  return (
    <>
          ...
          <Row>
            <Col className=" align-items-center flex-wrap">
              <div className="contact-info fs-3 ms-2  d-flex justify-content-center ">
                <h1 className="sayato">SAYATO-BREAKFAST</h1>
              </div>
      ...
      <Container >
              <Row className="mt-5" >
                {Menu1.map((product) => (
                  <Col key={product.id} sm={6} md={6} lg={4} xs={12} className="mb-4  d-flex justify-content-center">
                    <Card  className="box "
                      ...
                      <Card.Img variant="top" src={product.img} className="img-fluid" style={{height:250,width:300}}  />
